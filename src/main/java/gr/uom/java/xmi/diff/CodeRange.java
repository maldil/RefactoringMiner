...
public class CodeRange {
	...
	private int pythonStartLine;
	private CodeElementType codeElementType;
	private String description;
	private String codeElement;

	public CodeRange(String filePath, int startLine, int endLine,
			int startColumn, int endColumn,int pythonStartLine, CodeElementType codeElementType) {
		...
		this.pythonStartLine = pythonStartLine;
	}
	...
	public int getPythonStartLine() {
		return pythonStartLine;
	}
	...
	public String toString() {
		...
		encodeIntProperty(sb, "pythonStartLine", pythonStartLine, false);
	...
	public static CodeRange computeRange(Set<AbstractCodeFragment> codeFragments) {
		...
		for(AbstractCodeFragment fragment : codeFragments) {
			...
			pythonStarLine=info.getPythonStartLine();
		}
		return new CodeRange(filePath, minStartLine, maxEndLine, startColumn, endColumn,pythonStarLine, CodeElementType.LIST_OF_STATEMENTS);
	}
}