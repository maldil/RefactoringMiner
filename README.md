...
# General info
[RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) (developed by Nikolaos Tsantali et al.) is a Java library that can detect refactorings applied in the commit history of a Java project. We extend the RefactoringMiner to Python. Now, you can use this RefactoringMiner to detect refactorings applied in Python projects.
